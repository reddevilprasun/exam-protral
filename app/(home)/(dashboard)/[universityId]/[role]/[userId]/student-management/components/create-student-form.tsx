...
type SubmitFormValues = FunctionArgs<typeof api.user.teacherCreateStudent>;
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input {...field} placeholder="e.g. Joe" disabled={disable} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input {...field} placeholder="e.g. Roy" disabled={disable} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
